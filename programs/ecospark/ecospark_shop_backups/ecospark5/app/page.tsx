        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative w-full h-64 md:h-96 lg:h-[500px] rounded-eco overflow-hidden">
              <Image
                src="/products/bienenwachstuecher-set/image1.jpg"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            >
              <div className="relative w-full h-48 mb-4 rounded-eco overflow-hidden bg-off-white">
                <Image
                  src="/products/seedbomb-trio/image1.jpg"
                  alt="Grow Green Kits"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-200"
                  sizes="(max-width: 768px) 100vw, 50vw"
            ...
            >
              <div className="relative w-full h-48 mb-4 rounded-eco overflow-hidden bg-off-white">
                <Image
                  src="/products/solar-flower/image1.jpg"
                  alt="Eco Gadgets"
                  fill
                  className="object-cover group-hover:scale-105 transition-transform duration-200"
                  sizes="(max-width: 768px) 100vw, 50vw"
            ...
            >
              <div className="relative w-full h-48 mb-4 rounded-eco overflow-hidden bg-off-white">
                <Image
                  src="/products/tire-wallet/image1.jpg"
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative w-full h-64 md:h-96 rounded-eco overflow-hidden">
              <Image
                src="/products/plantable-pencils/image1.jpg"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-4">
            <div className="relative w-full h-48 md:h-64 rounded-eco overflow-hidden">
              <Image
                src="/products/bienenwachstuecher-set/image2.jpg"
            ...
            <div className="relative w-full h-48 md:h-64 rounded-eco overflow-hidden">
              <Image
                src="/products/bambus-besteck-set/image2.jpg"
                alt="EcoSpark Lifestyle"
                fill
                className="object-cover hover:scale-105 transition-transform duration-200"
                sizes="(max-width: 768px) 50vw, 25vw"
            ...
            <div className="relative w-full h-48 md:h-64 rounded-eco overflow-hidden">
              <Image
                src="/products/seedbomb-trio/image2.jpg"
                alt="EcoSpark Lifestyle"
                fill
                className="object-cover hover:scale-105 transition-transform duration-200"
                sizes="(max-width: 768px) 50vw, 25vw"
            ...
            <div className="relative w-full h-48 md:h-64 rounded-eco overflow-hidden">
              <Image
                src="/products/plantable-pencils/image2.jpg"
                alt="EcoSpark Lifestyle"
                fill
                className="object-cover hover:scale-105 transition-transform duration-200"
                sizes="(max-width: 768px) 50vw, 25vw"
            ...
            <div className="relative w-full h-48 md:h-64 rounded-eco overflow-hidden">
              <Image
                src="/products/solar-flower/image2.jpg"
                alt="EcoSpark Lifestyle"
                fill
                className="object-cover hover:scale-105 transition-transform duration-200"
                sizes="(max-width: 768px) 50vw, 25vw"
            ...
            <div className="relative w-full h-48 md:h-64 rounded-eco overflow-hidden">
              <Image
                src="/products/tire-wallet/image2.jpg"
                alt="EcoSpark Lifestyle"
                fill
                className="object-cover hover:scale-105 transition-transform duration-200"
                sizes="(max-width: 768px) 50vw, 25vw"
